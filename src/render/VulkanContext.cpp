...
void VulkanContext::pickPhysicalDevice() {
  ...
  physicalDevice =
    *std::max_element(devices.begin(), devices.end(), [&](VkPhysicalDevice a, VkPhysicalDevice b) {
...
void VulkanContext::createDescriptorPool() {
  ...
  vkCheck(vkCreateDescriptorPool(device, &ci, nullptr, &descriptorPool), "vkCreateDescriptorPool");
}
